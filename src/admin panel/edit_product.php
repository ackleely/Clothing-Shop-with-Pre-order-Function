<?php
    ...
    if (isset($_POST['update'])) {
        ...
        if (!empty($image)){
            if ($image_size > 2000000) {
                ...
                $success_msg[] = 'product and image updated';
            }
        } 
    ...
    if (isset($_POST['delete_image'])){
        ...
        $success_msg[] = 'product image deleted';
    }
...
<head>
    ...
    <title>Vintage 88 - Edit Product</title>
                    ...
                    <form action="" method="post" enctype="multipart/form-data" class="register">
                        ...
                        <div class="input-field">
                            ...
                            <?php if($fetch_product['image'] != ''){?>
                                <img src="../uploaded_files/<?= $fetch_product['image']; ?>" class="box">
                                <div class="flex-btn">
