...
<head>
    ...
    <title>Vintage 88 - Total Order Page</title>
    ...
    <div class="main-container">
        ...
        <section class="order-container">
            ...
            <div class="box-container">
               ...
               <div class="box">
                    <div class="status" style="color: <?php if($fetch_order['payment_status']=='in transit')
                        {echo "limegreen";}else{echo "red";} ?>"><?= $fetch_order['payment_status']; ?>
                    </div>
