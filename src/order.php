...
<head>
    ...
    <title>Vintage 88 - User Order Page</title>
                ...
                <a href="view_order.php?get_id=<?= $fetch_orders['id']; ?>">
                    ...
                    <div class="content">
                        ...
                        <div class="row">
                            ...
                            <p class="status" style="color: <?php if($fetch_orders['payment_status'] == 'delivered'){echo "green";}elseif($fetch_orders['payment_status'] == 'canceled'){echo "red";}else{echo "orange";} ?>"> <?= $fetch_orders['payment_status']; ?> </p>
                        </div>
                    </div>
                </a>
            </div>
