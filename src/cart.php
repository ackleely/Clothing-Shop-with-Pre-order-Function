<?php
    ...
    if (isset($_POST['delete_item'])) {
        ...
        if ($verify_delete_item->rowCount() > 0) {
            ...
            $warning_msg[] = 'item already deleted from cart';
        }
    }
...
<head>
    ...
    <title>Vintage 88 - Cart Page</title>
            ...
            <form action="" method="post" class="box <?php if($fetch_products['stock'] == 0){echo "disabled";} ?>">
                ...
                <div class="content">
                    ...
                    <div class="flex-btn">
                        ...
                        <button type="submit" name="delete_item" class="btn" onclick="retirn confirm('remove from cart');">delete</button>
                    </div>
                </div>
