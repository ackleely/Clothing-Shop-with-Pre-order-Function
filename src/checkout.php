        ...
        if (isset($_GET['get_id'])) {
            ...
            if ($get_product->rowCount() > 0) {
                while($fetch_p = $get_product->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    $insert_order = $conn->prepare("INSERT INTO `orders`(id, user_id, seller_id, name, number, email, address, address_type, method, product_id, price, qty) VALUE(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
...
<head>
    ...
    <title>Vintage 88 - Checkout Page</title>
                    ...
                    <div class="box">
                        ...
                        <div class="input-field">
                            ...
                            <select name="address_type" class="input">
                                ...
                                <option value="credit or debit card">office</option>
                            </select>
                        </div>
                    </div>
                    <div class="box">
                        ...
                        <div class="input-field">
                            ...
                            <input type="number" name="pin" required maxlength="4" min="0" placeholder="e.g 4014" class="input">
                        </div>
                    </div>
                </div>
                <br>
                ...
                <div class="box-container">
                    ...
                    <div class="flex">
                        ...
                        <div>
                            ...
                            <p class="price">Php <?= $fetch_products['price']; ?> X <?= $fetch_cart['qty']; ?></p>
                        </div>
                    </div>
